...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center text-center bg-gradient-to-b from-white to-gray-50 px-4 overflow-hidden">
      ...
      >
        <div className="w-[350px] h-[350px] md:w-[500px] md:h-[500px] bg-blue-300 rounded-full filter blur-3xl opacity-50" />
      </motion.div>
      ...
      <motion.img
        ...
        transition={{
          ...
          '--angle': { duration: 5, repeat: Infinity, ease: "linear" }
        }}
      />

      {/* Judul typewriter */}
      <motion.h1
        className="text-3xl sm:text-5xl md:text-6xl font-extrabold mb-4 mt-4"
      ...
      {/* Subjudul */}
      <motion.p
        className="text-gray-600 text-lg sm:text-xl md:text-2xl max-w-2xl mb-8"
      ...
      >
        ...
        <a
          href="#contact"
          className="px-6 py-3 border-2 border-blue-500 text-blue-500 rounded-full font-semibold hover:bg-blue-50 transition shadow flex items-center gap-2"
        >
